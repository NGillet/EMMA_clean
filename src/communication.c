                ...
                if(nextoct != NULL) {
                    ...
                    if(found) { // the reception oct has been found
                        ...
                        if(newcell->child != NULL) {
                            ...
                            int xp = (int)(DFACT * (part->x - newoct->x) / dxcur2);
                            xp = (xp > 1 ? 1 : xp);
                            xp = (xp < 0 ? 0 : xp);
                            int yp = (int)(DFACT * (part->y - newoct->y) / dxcur2);
                            yp = (yp > 1 ? 1 : yp);
                            yp = (yp < 0 ? 0 : yp);
                            int zp = (int)(DFACT * (part->z - newoct->z) / dxcur2);
                            zp = (zp > 1 ? 1 : zp);
                            zp = (zp < 0 ? 0 : zp);
                            int ip = xp + yp * 2 + zp * 4;
