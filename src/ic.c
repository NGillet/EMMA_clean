        ...
        for(i2 = 0; i2 < np2; i2++) {
            ...
            for(i1 = 0; i1 < np1; i1++) {
                ...
                if(found) {
                    ...
                    if(W.p < PMIN) {
                        printf(" YOU SHOULD RECONSIDER PMIN %e %e %e %e temp=%e rhob=%e\n", W.p, pressure, pstar, PMIN, temp, rhob);
                        abort();
                    }
        ...
        for(i2 = 0; i2 < np2; i2++) {
            ...
            for(i1 = 0; i1 < np1; i1++) {
                ...
                if(found) {
                    ...
                    if(W.p < PMIN) {
                        printf(" YOU SHOULD RECONSIDER PMIN %e %e %e %e\n", W.p, pressure, pstar, PMIN);
                        abort();
                    }
